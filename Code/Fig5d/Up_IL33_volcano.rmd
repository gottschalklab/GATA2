...
data_f <- "/ix/djishnu/Aaron_F/GATA2_paper/Data/volcano_plots/resultsOrdered_IL33_GATA2_24_Exp1_vs_IL33_WT_24_Exp1.txt"
deg_list_f <- "/ix/djishnu/Aaron_F/GATA2_paper/Data/volcano_plots/IL33_DEGs_FC_UP.txt"
...
logFC_threshold <- 1.35  # Adjust if needed
neg_log_p_threshold <- -log10(0.0001)
...
genes_to_label <- c("ARG1", "CCL2", "IL6", "IL1A", "MMP12", "ADAM8")
...
```{r}
# Open a square PDF
pdf("UP_IL33_GATA2_wrt_WT_volcano_plot.pdf", width = 4, height = 3)
